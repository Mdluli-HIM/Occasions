...
export function ProviderOnboardingFlow({
  ...
  // Persists this step's data to PATCH /api/onboarding (BACKEND_HANDOFF.md
  // section 5.6/7). localStorage above remains a fast local draft/cache —
  // the API call is what actually creates/updates the provider record.
  async function persistToApi(finalize = false) {
    setIsSaving(true);
    try {
  ...
  async function goNext() {
    ...
    await persistToApi(nextStep === "success");
        ...
        <div className="mx-auto flex min-h-24 max-w-7xl items-center justify-between px-5 md:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={async () => {
                await persistToApi(false);
                router.push("/provider-dashboard/listing");
              }}
      ...
      {stepId !== "success" ? (
        <footer className="fixed inset-x-0 bottom-0 z-50 border-t border-[#deded9] bg-white">
          <div className="h-2 bg-[#deded9]">
            <div
              className="h-full bg-[#ff5a40] transition-all duration-300"
          ...
          <div className="mx-auto flex min-h-24 max-w-7xl items-center justify-between px-5 md:px-8">
            ...
            <button
              ...
              onClick={goNext}
              className="inline-flex min-h-[52px] min-w-[128px] items-center justify-center gap-2 rounded-[16px] bg-[#111111] px-6 text-sm font-black text-white transition hover:bg-[#ff5a40] disabled:cursor-not-allowed disabled:bg-[#e5e5e5] disabled:text-[#9aa4b5]"
            >
...
function SuccessStep() {
  return (
    <section className="mx-auto flex min-h-[calc(100vh-160px)] max-w-3xl flex-col items-center justify-center px-5 text-center md:px-8">
      <div className="flex size-20 items-center justify-center rounded-full bg-[#ff5a40] text-white">
      ...
      >
        <span className="text-white">Manage my listing</span>
