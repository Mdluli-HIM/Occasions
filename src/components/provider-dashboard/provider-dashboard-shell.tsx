    ...
    <main className="min-h-screen bg-[#f6f6f4] text-[#111111]">
      ...
      <div className="mx-auto grid max-w-7xl gap-6 px-5 py-6 md:px-8 lg:grid-cols-[260px_minmax(0,1fr)]">
        <aside className="lg:sticky lg:top-24 lg:self-start">
          ...
          >
            <span
              className="pointer-events-none absolute left-3 right-3 top-3 z-0 h-[52px] rounded-[18px] bg-[#ff5a40] shadow-[0_14px_30px_rgba(255,90,64,0.22)] transition-transform duration-300 ease-out"
              style={{
